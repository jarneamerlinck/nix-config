...

{
  ...
  virtualisation.oci-containers.containers."syncthing" = {
    ...
    volumes = [ "/data/sync/:/var/syncthing/:rw" ];
    ports =
      [ "8384:8384/tcp" "22000:22000/tcp" "22000:22000/udp" "21027:21027/udp" ];
    log-driver = "journald";
    extraOptions = [
  ...
  systemd.services."docker-syncthing" = {
    ...
    after = [ "docker-network-syncthing_default.service" ];
    requires = [ "docker-network-syncthing_default.service" ];
