...
let
  ...
  version = "v3.2.2"; # imgupdate https://github.com/immich-app/immich/releases/
  upload_dir = "/data/docker/immich/data";
  db_dir = "/data/docker/immich/postgress";

  kiosk_url = "kiosk.ko0.net";
  kiosk_version = "0.43.2"; # imgupdate https://github.com/damongolding/immich-kiosk/releases
...
in
{
  ...
  sops.secrets."immich/backup_dest" = {
    sopsFile = ../../../../${config.networking.hostName}/secrets.yml;
  ...
  # Crontab sync
  systemd.services.immich-backup-script = {
  ...
  systemd.timers.immich-backup-script = {
    description = "Run the sync script daily at 2AM";
